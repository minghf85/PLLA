...
2. **单词注音**：使用Markdown的`<ruby>`标签为句子中的重要单词注音。注音应使用日语的假名发音规则。
3. **单词说明**：为每个注音的单词提供简要的解释或用法说明，帮助用户理解该单词在句子中的意义。
...
1. **语法说明**：解释句子的语法结构，说明句子中的各个成分（如主语、谓语、宾语等）以及它们的语法功能。
2. **单词发音**：使用Markdown的`<ruby>`标签为句子中的重要单词标注发音。发音可以使用国际音标（IPA）或自然发音标注（例如“类似中文的发音”）。
3. **单词翻译与说明**：为每个标注发音的单词提供中文翻译和简要的解释，帮助用户理解该单词在句子中的意义和用法。
...
2. **单词发音**：
   - I: <ruby>I<rt>/aɪ/</rt></ruby>（类似中文的“爱”）
   - like: <ruby>like<rt>/laɪk/</rt></ruby>（类似中文的“来克”）
   - reading: <ruby>reading<rt>/ˈriːdɪŋ/</rt></ruby>（类似中文的“瑞丁”）
   - books: <ruby>books<rt>/bʊks/</rt></ruby>（类似中文的“布克斯”）

3. **单词翻译与说明**：
   - I: 我 – 代词，指代说话者自己。
   - like: 喜欢 – 动词，表示对某事物的偏好或喜爱。
